...
\usepackage[subscriptcorrection,mtpcal,mtphrb]{mtpro2}
\usepackage{bm}
\usepackage{xspace}
\makeatletter
...
\langle#2,#3\rangle}{}
\ifthenelse{\equal{#1}{1}}{ % if
\bigl\langle#2,#3\bigr\rangle}{}
\ifthenelse{\equal{#1}{2}}{ % if
\Bigl\langle#2,#3\Bigr\rangle}{}
\ifthenelse{\equal{#1}{3}}{ % if
\biggl\langle#2,#3\biggr\rangle}{}
